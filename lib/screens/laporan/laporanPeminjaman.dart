...
class LaporanPeminjaman extends StatefulWidget {
  static const routeName = '/laporan_peminjaman';

  @override
  _LaporanPeminjamanState createState() => _LaporanPeminjamanState();
}

class _LaporanPeminjamanState extends State<LaporanPeminjaman> {
